...
define
    ...
    ValidCount == Len(bins.recycling) = count.recycling /\ Len(bins.trash) = count.trash
end define;
...
\* BEGIN TRANSLATION (chksum(pcal) = "65973a6f" /\ chksum(tla) = "303fff0f")
...
\* Last modified Sat Nov 19 10:23:29 CET 2022 by pwc
