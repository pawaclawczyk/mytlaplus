...
\fl{}\moduleLeftDash\cl{ {\MODULE} recycler}\moduleRightDash\cl{}
\fl{}
\fl{ {\EXTENDS} Integers ,\, Sequences ,\, FiniteSets ,\, TLC}
\fl{}
\fl{ {\p@mmalgorithm} recycler}
\fl{}
\fl{ {\p@variables}}
 \fl{ capacity \.{\in} [ recycle \.{:} 1 \.{\dotdot} 10 ,\, trash \.{:} 1
 \.{\dotdot} 10 ] ,\,}
 \fl{ bins \.{=} [ recycle \.{\mapsto} {\langle} {\rangle} ,\, trash
 \.{\mapsto} {\langle} {\rangle} ] ,\,}
\fl{ count \.{=} [ recycle \.{\mapsto} 0 ,\, trash \.{\mapsto} 0 ] ,\,}
 \fl{ item \.{=} [ type \.{:} \{\@w{recycle} ,\,\@w{trash} \} ,\, size \.{:} 1
 \.{\dotdot} 6 ] ,\,}
\fl{ items \.{\in} item \.{\times} item \.{\times} item \.{\times} item ,\,}
\fl{ curr {\p@semicolon}}
\fl{}
\fl{ {\p@macro} add\_item ( type ) {\p@begin}}
\fl{ bins [ type ] \.{:=} bins [ type ] \.{\cup} \{ curr \} {\p@semicolon}}
\fl{ count [ type ] \.{:=} count [ type ] \.{+} 1 {\p@semicolon}}
 \fl{ capacity [ type ] \.{:=} capacity [ type ] \.{-} curr . size
 {\p@semicolon}}
\fl{ {\p@end} {\p@macro} {\p@semicolon}}
\fl{}
\fl{ {\p@begin}}
\fl{ {\p@while} items \.{\neq} {\langle} {\rangle} {\p@do}}
\fl{ curr \.{:=} Head ( items ) {\p@semicolon}}
\fl{ items \.{:=} Tail ( items ) {\p@semicolon}}
 \fl{ {\p@if}}\al{24}{1}{ curr . type \.{=}\@w{recycle} \.{\land} curr . size
 \.{\leq} capacity . recycle {\p@then}}
\fl{ add\_item (\@w{recycle} )}
\fl{ {\p@elsif} curr . size \.{\leq} capacity . trash {\p@then}}
\fl{ add\_item (\@w{trash} )}
\fl{ {\p@end} {\p@if} {\p@semicolon}}
\fl{ {\p@end} {\p@while} {\p@semicolon}}
 \fl{ {\p@assert} capacity . trash \.{\geq} 0 \.{\land} capacity . recycle
 \.{\geq} 0 {\p@semicolon}}
 \fl{ {\p@assert} Cardinality ( bins . trash ) \.{=} count . trash
 {\p@semicolon}}
 \fl{ {\p@assert} Cardinality ( bins . recycle ) \.{=} count . recycle
 {\p@semicolon}}
...
\fl{ {\CONSTANT} defaultInitValue}
 \fl{ {\VARIABLES} capacity ,\, bins ,\, count ,\, item ,\, items ,\, curr ,\,
 pc}
\fl{}
 \fl{ vars}\al{39}{1}{ \.{\defeq} {\langle} capacity ,\, bins ,\, count ,\,
 item ,\, items ,\, curr ,\, pc {\rangle}}
\fl{}
\fl{ Init}\al{41}{1}{ \.{\defeq}}\al{41}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
 \fl{ \.{\land}}\al{42}{1}{ capacity \.{\in} [ recycle \.{:} 1 \.{\dotdot} 10
 ,\, trash \.{:} 1 \.{\dotdot} 10 ]}
 \fl{ \.{\land}}\al{43}{1}{ bins \.{=} [ recycle \.{\mapsto} \{ \} ,\,
 trash}\al{43}{10}{ \.{\mapsto}}\al{43}{11}{ \{ \} ]}
 \fl{ \.{\land}}\al{44}{1}{ count \.{=} [ recycle \.{\mapsto} 0 ,\,
 trash}\al{44}{9}{ \.{\mapsto}}\al{44}{10}{ 0 ]}
 \fl{ \.{\land}}\al{45}{1}{ item \.{=} [ type \.{:} \{\@w{recycle}
 ,\,\@w{trash} \} ,\, size \.{:} 1 \.{\dotdot} 6 ]}
 \fl{ \.{\land}}\al{46}{1}{ items \.{\in} item \.{\times} item \.{\times} item
 \.{\times} item}
\fl{ \.{\land}}\al{47}{1}{ curr \.{=} defaultInitValue}
\fl{ \.{\land}}\al{48}{1}{ pc \.{=}\@w{Lbl\_1}}
\fl{}
\fl{ Lbl\_1 \.{\defeq}}\al{50}{2}{ \.{\land}}\al{50}{3}{ pc \.{=}\@w{Lbl\_1}}
 \fl{ \.{\land}}\al{51}{1}{ {\IF}}\al{51}{2}{ items \.{\neq} {\langle}
 {\rangle}}
 \fl{ \.{\THEN}}\al{52}{1}{ \.{\land}}\al{52}{2}{ curr \.{'} \.{=} Head (
 items )}
\fl{ \.{\land}}\al{53}{1}{ items \.{'} \.{=} Tail ( items )}
 \fl{ \.{\land}}\al{54}{1}{ {\IF}}\al{54}{2}{ curr \.{'} . type
 \.{=}\@w{recycle} \.{\land} curr \.{'} . size \.{\leq} capacity . recycle}
 \fl{ \.{\THEN}}\al{55}{1}{ \.{\land}}\al{55}{2}{ bins \.{'} \.{=} [ bins
 {\EXCEPT} {\bang} [\@w{recycle} ] \.{=} bins [\@w{recycle} ] \.{\cup} \{
 curr \.{'} \} ]}
 \fl{ \.{\land}}\al{56}{1}{ count \.{'} \.{=} [ count {\EXCEPT} {\bang}
 [\@w{recycle} ] \.{=} count [\@w{recycle} ] \.{+} 1 ]}
 \fl{ \.{\land}}\al{57}{1}{ capacity \.{'} \.{=} [ capacity {\EXCEPT} {\bang}
 [\@w{recycle} ] \.{=} capacity [\@w{recycle} ] \.{-} curr \.{'} . size ]}
 \fl{ \.{\ELSE}}\al{58}{1}{ \.{\land} {\IF}}\al{58}{3}{ curr \.{'} . size
 \.{\leq} capacity . trash}
 \fl{ \.{\THEN}}\al{59}{1}{ \.{\land}}\al{59}{2}{ bins \.{'} \.{=} [ bins
 {\EXCEPT} {\bang} [\@w{trash} ] \.{=} bins [\@w{trash} ] \.{\cup} \{ curr
 \.{'} \} ]}
 \fl{ \.{\land}}\al{60}{1}{ count \.{'} \.{=} [ count {\EXCEPT} {\bang}
 [\@w{trash} ] \.{=} count [\@w{trash} ] \.{+} 1 ]}
 \fl{ \.{\land}}\al{61}{1}{ capacity \.{'} \.{=} [ capacity {\EXCEPT} {\bang}
 [\@w{trash} ] \.{=} capacity [\@w{trash} ] \.{-} curr \.{'} . size ]}
\fl{ \.{\ELSE}}\al{62}{1}{ \.{\land}}\al{62}{2}{ {\TRUE}}
 \fl{ \.{\land}}\al{63}{1}{ {\UNCHANGED} {\langle}}\al{63}{3}{ capacity ,\,
 bins ,\,}
\fl{ count {\rangle}}
\fl{ \.{\land}}\al{65}{1}{ pc \.{'} \.{=}\@w{Lbl\_1}}
 \fl{ \.{\ELSE}}\al{66}{1}{ \.{\land}}\al{66}{2}{ Assert (}\al{66}{4}{
 capacity . trash \.{\geq} 0 \.{\land} capacity . recycle \.{\geq} 0 ,\,}
\fl{\@w{Failure\ of\ assertion\ at\ line\ 31,\ column\ 5.} )}
 \fl{ \.{\land}}\al{68}{1}{ Assert (}\al{68}{3}{ Cardinality ( bins . trash )
 \.{=} count . trash ,\,}
\fl{\@w{Failure\ of\ assertion\ at\ line\ 32,\ column\ 5.} )}
 \fl{ \.{\land}}\al{70}{1}{ Assert (}\al{70}{3}{ Cardinality ( bins . recycle
 ) \.{=} count . recycle ,\,}
\fl{\@w{Failure\ of\ assertion\ at\ line\ 33,\ column\ 5.} )}
\fl{ \.{\land}}\al{72}{1}{ pc \.{'} \.{=}\@w{Done}}
 \fl{ \.{\land}}\al{73}{1}{ {\UNCHANGED} {\langle} capacity ,\, bins ,\, count
 ,\, items ,\, curr {\rangle}}
\fl{ \.{\land}}\al{74}{1}{ item \.{'} \.{=} item}
\fl{}
\fl{}
\fl{ Terminating \.{\defeq} pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}
\fl{}
\fl{ Next}\al{79}{1}{ \.{\defeq}}\al{79}{2}{ Lbl\_1}
\fl{ \.{\lor} Terminating}
\fl{}
 \fl{ Spec}\al{82}{1}{ \.{\defeq}}\al{82}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
